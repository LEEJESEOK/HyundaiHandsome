		...
		<div id="contents" class="container" style="padding-top: 87px;">
			<div claXss="page-body-wrapper">
				...
				<div>
					<h2 class="hs-row tit_page tit_brand">
						<img src="${contextPath}/images/thumbs/beauty-big-1.png" class="tit--img"
							alt="브랜드 이미지">
					</h2>
				</div>
			</div>
			<div class="hs-row box">
				<ol class="breadcrumb col-r">
					...
					<li class="breadcrumb-item"><a href="${contextPath}/brand/beauty.do">뷰티</a></li>
				</ol>
			</div>
			...
			<div class="section box">
				<div class="hs-row clear beauty mt30">
					<div class="col-r col-md-5" style="right: 10px;">
						...
						<div class="col-r">
							<img src="${contextPath}/images/thumbs/brand-view-1_2.jpg"
								alt="브랜드관 제품에 대한 작은 이미지">
						</div>
					</div>
					<div class="col-md">
						<img src="${contextPath}/images/thumbs/brand-view-1_1.jpg"
							alt="브랜드관 제품에 대한 이미지">
					</div>
				</div>
			</div>
			...
			<script>
				function goBrandPav01(brNum) {
					window.open('http://www.thehandsome.com${contextPath}/b/br' + brNum);
				}

				function goBrandPav02(brNum) {
					window.open('http://www.thehandsome.com${contextPath}/c/br' + brNum
							+ '/br' + brNum);
				}
