				...
				<div class="page-body-wrapper">
					...
					<div class="hs-row box">
						<ol class="breadcrumb col-r">
							...
							<li class="breadcrumb-item"><a href="/ko/company/ethicalMgmt03.do">임직원 윤리실천경영</a></li>
						</ol>
					</div>
					<h2 class="hs-row tit_page tit-bg-none">
						<span>윤리경영</span>
						<!-- <img src="${contextPath}/images/thumbs/company-bg-.jpg" alt="윤리경영"> -->
					</h2>
					<div class="section box"> <!-- 섹션 1 -->
						<div class="hs-row tabs">
							<ul class="nav nav-tabs nav-justified rootTab">
								...
								<li class="on"><a href="/ko/company/ethicalMgmt03.do">임직원 윤리실천경영</a></li><!-- 활성화된 페이지 li class="on" -->
							</ul>
						</div>
