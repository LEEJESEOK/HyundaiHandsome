							...
							<div class="drop-banner">
								<a href="#none">
									<div class="drop-banner-image">
										<img src="../images/thumbs/nav-img1_1.jpg"
					...
					<li id="" data-id=""><a href="/ko/brand/fashion.do"
						...
						<div class="gnb-drop-wrap">
							...
							<div class="drop-banner">
								<a href="#none">
									<div class="drop-banner-image">
										<img src="../images/thumbs/nav-img2_1.jpg"
					...
					<li id="" data-id=""><a href="/ko/media/collectionList.do"
						...
						<div class="gnb-drop-wrap">
							...
							<div class="drop-banner">
								<a href="#none">
									<div class="drop-banner-image">
										<img src="../images/thumbs/nav-img3_1.jpg"
											class="drop-img-src" alt=" 에 대한 이미지">
									</div>
								</a>
							</div>
					...
					<li id="" data-id=""><a href="/ko/ir/governance01.do"
						...
						<div class="gnb-drop-wrap">
							...
							<div class="drop-banner">
								<a href="#none">
									<div class="drop-banner-image">
										<img src="../images/thumbs/nav-img4_1.jpg"
											class="drop-img-src" alt=" 에 대한 이미지">
									</div>
								</a>
							</div>
					...
					<li id="" data-id=""><a
						...
						<div class="gnb-drop-wrap">
							...
							<div class="drop-banner">
								<a href="#none">
									<div class="drop-banner-image">
										<img src="../images/thumbs/nav-img5_1.jpg"
											class="drop-img-src" alt=" 에 대한 이미지">
									</div>
								</a>
							</div>
